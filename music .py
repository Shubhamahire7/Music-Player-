...
op = Image.open("D:\\project\\musicplayer\\unknown.png")
...
Prev=Button(buttonframe,text="Prev",image=render1,command=Prevsong,bg="white" ,borderwidth=0).place(x=300,y=200)
play=Button(buttonframe,text="play",image=render2,command=playsong ,bg="white",borderwidth=0).place(x=400,y=200)
Next=Button(buttonframe,text="Next",image=render3,command=Nextsong,bg="white",borderwidth=0).place(x=500,y=200)
